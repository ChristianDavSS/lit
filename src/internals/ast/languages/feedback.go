...
var Messages = map[string][]Feedback{
	"parameters": {
		...
		Feedback{Value: 8, Message: "WARNING: The function is dangerous and has many responsibilities. You may want to make it cleaner/readable.\n"},
	...
	"complexity": {
		...
		Feedback{Value: 20, Message: "POTENTIAL ERROR: The function it's too complex and unreadable, taking too much decisions. You must modify it and make it cleaner!.\n"},
	},
	"size": {
